...
for index, ALTER_SETTINGS in enumerate(CONST_SIM_ALTER):
	if index == 0: CONST_NUM_CLUSTERS = ['# ***Clusters***', 1]
	elif index == 1: CONST_NUM_CLUSTERS = ['# ***Clusters***', 2]
	elif index == 2: CONST_NUM_CLUSTERS = ['# ***Clusters***', 4]
	...
	for ALTER_PROPERTY in ALTER_SETTINGS:
